...
#    Updated: 2024/12/02 11:27:51 by dkajiwar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME = push_swap
HEAD = push_swap.h
SRCS = main.c node_initialization.c coordinate_compression.c bit_operations.c utils.c node_operations_1.c node_operations_2.c node_operations_3.c sort.c handle_errors.c simple_sort.c sort_3_mods.c sort_4_mods.c sort_5_mods.c
OBJS = $(SRCS:.c=.o)
